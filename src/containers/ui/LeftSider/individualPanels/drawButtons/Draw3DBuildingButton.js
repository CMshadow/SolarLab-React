    ...
    const DrawBuildingPolygon = (
        <Button
            ...
            onClick = {() => {
                ...
                buildingFoundation = props.CreateBuildingFoundationPolygon(buildingFoundationHeight, buildingCoordinatesArray);
                console.log('Starting Building' + props.DrawingBuidingFoundation.height);
