        ...
        return {
            ...
            icon: {
                panel: {
                    ...
                    value: state.metadata.option.data.PV_Installed_Capacity,
                    suffix: 'W',
                    precision: 1,
                },
                dollar: {
                    image: dollar,
                    title: 'Project Cost',
                    value: state.metadata.option.data.Project_Cost,
                    suffix: ' USD',
                    precision: 1,
                },
                factory: {
                    ...
                    value: state.metadata.option.data.CO2_Reduced,
                    suffix: 'tons/year',
                    precision: 1,
                },
                house: {
                    ...
                    value: state.metadata.option.data.Annual_PV_Production,
                    suffix: 'Wh',
                    precision: 1,
                },
            }
